...
#include <WiFi.h>             //For WiFi conectivity
...
//-----------For WiFi----------------------//
#define WIFI_SSID "WIFI_SSID"          //WiFi name
...
#define AUTHOR_EMAIL "AUTHOR_EMAIL"        //Sende E-Mail address
#define AUTHOR_PASSWORD "AUTHOR_PASSWORD"  //Sender application key

// Recipient's email
#define RECIPIENT_EMAIL "RECIPIENT_EMAIL"  //Receiver e-Mail address
